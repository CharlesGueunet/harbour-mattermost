...
SET_SETTINGS_PROPERTY(bool,  useChannelNames)
...
void SettingsContainer::fromJsonObject(const QJsonObject &settings)
{
	...
	if (settings.contains("m_useChannelNames")) FROM_VALUE(m_useChannelNames, toBool());
